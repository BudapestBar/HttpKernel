...
use BudapestBar\Component\HttpKernel\Controller\ControllerResolver;
...
class ControllerResolverTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testGetController()
    {
        ...
        $request->attributes->set('_controller', 'BudapestBar\Component\HttpKernel\ControllerResolverTest::testGetController');
        $controller = $resolver->getController($request);
        $this->assertInstanceOf('BudapestBar\Component\HttpKernel\ControllerResolverTest', $controller[0], '->getController() returns a PHP callable');
        ...
        $request->attributes->set('_controller', 'BudapestBar\Component\HttpKernel\ControllerResolverTest');
        $controller = $resolver->getController($request);
        $this->assertInstanceOf('BudapestBar\Component\HttpKernel\ControllerResolverTest', $controller);

        $request->attributes->set('_controller', array($this, 'controllerMethod1'));
        $controller = $resolver->getController($request);
        $this->assertSame(array($this, 'controllerMethod1'), $controller);

        $request->attributes->set('_controller', array('BudapestBar\Component\HttpKernel\ControllerResolverTest', 'controllerMethod4'));
        $controller = $resolver->getController($request);
        $this->assertSame(array('BudapestBar\Component\HttpKernel\ControllerResolverTest', 'controllerMethod4'), $controller);

        $request->attributes->set('_controller', 'BudapestBar\Component\HttpKernel\some_controller_function');
        $controller = $resolver->getController($request);
        $this->assertSame('BudapestBar\Component\HttpKernel\some_controller_function', $controller);
        ...
        $request->attributes->set('_controller', 'BudapestBar\Component\HttpKernel\ControllerResolverTest::bar');
        try {
            $resolver->getController($request);
    ...
    public function testGetArguments()
    {
        ...
        $controller = 'BudapestBar\Component\HttpKernel\some_controller_function';
    ...
    {
        $mock = $this->getMock('BudapestBar\Component\HttpKernel\Controller\ControllerResolver', array('createController'));
        $mock->expects($this->once())->method('createController')->will($this->returnValue('BudapestBar\Component\HttpKernel\some_controller_function'));
