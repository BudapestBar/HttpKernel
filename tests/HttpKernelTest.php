...
use BudapestBar\Component\HttpKernel\KernelEvents;
use BudapestBar\Component\HttpKernel\Exception\MethodNotAllowedHttpException;
use BudapestBar\Component\HttpKernel\Exception\AccessDeniedHttpException;
...
class HttpKernelTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @expectedException \BudapestBar\Component\HttpKernel\Exception\NotFoundHttpException
     */
    ...
    {
        $dispatcher = new EventDispatcher();
        $kernel = new HttpKernel($dispatcher, $this->getResolver('BudapestBar\Component\HttpKernel\controller_func'));
    ...
    {
        $dispatcher = new EventDispatcher();
        $kernel = new HttpKernel($dispatcher, $this->getResolver(array('BudapestBar\Component\HttpKernel\Controller', 'staticcontroller')));
    ...
    protected function getResolver($controller = null)
    {
        ...
        $resolver = $this->getMock('BudapestBar\\Component\\HttpKernel\\Controller\\ControllerResolverInterface');
